...
%% typeset.  (There is a default binding correction of 5 mm for the print versions, which gets
%% overwritten here.)
%% Here, for illustration, we also print a thumb index (which automatically happens on
%% every recto page).
\documentclass[printa4, authorindex, bcor=10mm, thumbindex]{../guitarsongbook}
