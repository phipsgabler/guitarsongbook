...
%% typeset.  (There is a default binding correction for the print versions, which bcor overwrites;
%% for the screen versions, there is no binding correction by default, but you can specify one, as
%% here.)
\documentclass[screena4, authorindex, bcor=10mm]{../guitarsongbook}
...
%% If you want to leave out the title of an instrumental, you 
%% have to give it an empty argument.
\begin{instrumental}{}
\[C D E F]
\[G A B]
\end{instrumental}
