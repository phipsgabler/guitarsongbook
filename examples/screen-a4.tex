...
%% `authorindex' class option. You need to run the songindex program to get something
%% out of this!
\maketitleindex
\makeauthorindex
...
%% Here, we can set chords which are used in the piece. The heading text  be 
%% customized via the pgf key "/gsb/tabsheading".
\begin{tabs}
...
%% The first chorus is special in that it contains a "header" and sets up
%% the memorization register "chorus" for subsequent choruses. The header can be 
%% customized via the pgf key "/gsb/chorusheading".
\begin{firstchorus} % or: \beginfirstchorus
There i\[Am]s a h\[C]ouse in \[D]New Or\[F]leans
They \[Am]call the R\[C]ising \[E7]Sun, \[E7]
And it's \[Am]been the ru\[C]in of m\[D]any a poor \[F]boy.
And \[Am]God, I \[E]know I'm \[Am]one. \[E7]
\end{firstchorus} % or: \endchorus
